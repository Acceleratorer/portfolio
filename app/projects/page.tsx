  ...
  return (
    <main className="px-5 pb-24 pt-32">
      <section className="mx-auto max-w-6xl">
        <p className="text-xs font-black uppercase text-brand-coral">Projects</p>
        <h1 className="mt-4 max-w-4xl font-display text-5xl font-black uppercase leading-none tracking-normal sm:text-7xl">Case studies and shipped experiments.</h1>
          ...
          {projects.map((project) => (
            <article key={project.slug} className="overflow-hidden rounded-feature border border-hairline bg-surface-card transition hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <h2 className="mt-4 font-display text-2xl font-black uppercase tracking-normal">{project.title}</h2>
