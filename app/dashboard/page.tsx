  ...
  return (
    <main className="px-5 pb-24 pt-32">
      <section className="mx-auto max-w-6xl">
        <p className="text-xs font-black uppercase text-brand-coral">Dashboard</p>
        <h1 className="mt-4 max-w-4xl font-display text-5xl font-black uppercase leading-none tracking-normal sm:text-7xl">Accelra public command center.</h1>
          ...
          {proofStats.map((stat, index) => {
            ...
            return (
              <article key={stat.label} className="panel rounded-feature p-6">
                ...
                <strong className="mt-6 block font-display text-5xl font-black tracking-normal text-gradient">{stat.value}+</strong>
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-3">
          {[
            ...
            <article key={title} className="panel rounded-feature p-6">
              ...
              <h2 className="mt-5 text-xl font-black uppercase tracking-normal">{title}</h2>
