...
const HeroOrbitScene = dynamic(() => import("@/components/three/HeroOrbitScene"), {
  ssr: false,
  loading: () => (
    <div className="h-full w-full animate-pulse bg-[radial-gradient(circle_at_50%_45%,rgba(114,247,178,0.18),rgba(0,0,0,0)_48%)]" />
  ),
});
